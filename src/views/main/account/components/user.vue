<template>
  <div class="user-header">
    <div>
      <el-select v-model="role" clearable placeholder="全部角色" size="large"
                 style="width: 191px; height: 40px; margin-right: 20px">
        <el-option
    ...
    <el-button style="width: 80px; height: 40px" type="primary" @click="addUser('add')">添加用户</el-button>
  </div>
...
<!--        </template>-->
      ...
      >
        <el-form-item label="手机号" prop="phone">
          <el-input v-model="formLabelAlign.phone" :disabled="!isAdd"  placeholder="请输入手机号" style="height: 50px"/>
        </el-form-item>
